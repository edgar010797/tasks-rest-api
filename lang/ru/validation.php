...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'Данное значение :attribute обнаружено в утечке данных. Пожалуйста, выберите другое значение.',
    ],
    ...
    */
    ...
    | на более удобный для чтения, например, "Адрес электронной почты"
    | вместо "email". Это просто помогает сделать наши сообщения более
    | выразительными.
    |
    */
